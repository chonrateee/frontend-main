...
export default function NikeStore() {
  const nikeShoes = [
    { 
      ...
      price: 4200, 
      img: "/images/brands/nike/N1.jpg",
      rating: 4.7, 
      reviews: 1024,
      details: [
        "วัสดุ: Nike Flyknit บางเบา ระบายอากาศดี",
        "พื้นรองเท้า: Nike Air Zoom สำหรับการตอบสนองที่รวดเร็ว",
        "น้ำหนัก: 295 กรัม",
        "เหมาะสำหรับ: วิ่งระยะกลางถึงยาว",
        "สีที่มีจำหน่าย: ดำ, ขาว, เทา, น้ำเงิน, แดง",
        "จุดเด่น: รองรับการวิ่งแบบ responsive ทนทาน ใส่สบายยาวนาน"
      ]
    },
    { 
      id: 2, 
      ...
      price: 3800, 
      img: "/images/brands/nike/N2.jpg",
      rating: 4.8, 
      reviews: 2156,
      details: [
        "วัสดุ: หนังแท้คุณภาพสูง ผสมผ้าใบ",
        "พื้นรองเท้า: Nike Air cushioning ในส้นเท้า",
        "น้ำหนัก: 380 กรัม",
        "เหมาะสำหรับ: ใส่ประจำวัน lifestyle",
        "สีที่มีจำหน่าย: ขาว, ดำ, ขาว-ดำ, ขาว-แดง",
        "จุดเด่น: ไอคอนิคดีไซน์ คลาสสิคไม่เอาท์ ทนทานสูง"
      ]
    }
  ];
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)' }}>
      {/* Header */}
      <div style={{ 
        background: 'linear-gradient(135deg, #000000 0%, #1f2937 50%, #ff6b35 100%)', 
        color: 'white', 
        padding: '64px 16px',
        textAlign: 'center',
        position: 'relative',
        ...
        <div style={{ 
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at 30% 40%, rgba(255, 107, 53, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(255, 255, 255, 0.1) 0%, transparent 50%)'
        }}></div>
            ...
            <div key={shoe.id} style={{ 
              ...
              <div style={{ padding: '32px' }}>
                ...
                <p style={{ 
                  ...
                  {shoe.id === 1 ? 
                    "รองเท้าวิ่งเทคโนโลยี Nike Air Zoom พร้อม Flyknit อัปเปอร์ที่ระบายอากาศดี เหมาะสำหรับนักวิ่งที่ต้องการความตอบสนองที่รวดเร็ว" :
                    "รองเท้าไอคอนิคแห่งยุค Nike Air Force 1 ที่ผสมผสานสไตล์คลาสสิคกับความทนทาน เหมาะสำหรับการใช้งานประจำวัน"
                  }
                </p>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <button 
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.transform = 'scale(1.1)';
                    e.target.style.boxShadow = '0 8px 16px rgba(255, 107, 53, 0.4)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'scale(1)';
            ...
            <div style={{ padding: '32px' }}>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <p style={{ margin: 0, display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <span style={{ color: '#10b981', fontWeight: 'bold' }}>✓</span>
                    ทดลองใส่ได้ที่ร้าน Nike ทุกสาขา
                  </p>
                </div>
              </div>
